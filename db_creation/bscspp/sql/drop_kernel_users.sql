/*
|| Script to drop all kernel users from the DB
|| $Log: drop_kernel_users.sql,v $
...
SPOOL drop_kernel_users_&&start_date..sql
...
START drop_kernel_users_&&start_date..sql

!rm drop_kernel_users_&&start_date..sql
